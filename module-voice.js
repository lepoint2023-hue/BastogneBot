...
const GREETINGS = {
  fr: "Bonjour, je suis l'assistante numérique de la commune de Bastogne. Je vous écoute.",
  nl: "Goedag, ik ben de digitale assistent van de gemeente Bastenaken. Ik luister.",
  en: "Hello, I'm the digital assistant for the municipality of Bastogne. I'm listening.",
  de: "Guten Tag, ich bin die digitale Assistentin der Gemeinde Bastogne. Ich höre zu.",
  es: "Hola, soy la asistente digital del municipio de Bastogne. Le escucho.",
  ar: "مرحباً، أنا المساعدة الرقمية لبلدية باستون. أستمع إليك.",
};
